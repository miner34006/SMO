...
begin
    ...
    while intensity < mMaxIntensity + mDeltaIntensity do begin
        ...
        printIterationStats(intensity, probabilityOfFailure, averageTimeInBuffer1, averageTimeInBuffer2, averageAppsInBuffer);
